...
def print_usage():
    ...
    print(
        "   -e      Example of new data submission for storage in the "
        "server's dataset."
    )
    print("   -h      Print this help message.")
    print(
        "   -m      Retrieve a classification performance report of the "
        "server's trained model."
    )
    print(
        "   -r      Reset the state of the machine learning model and the "
        "stored data."
    )
